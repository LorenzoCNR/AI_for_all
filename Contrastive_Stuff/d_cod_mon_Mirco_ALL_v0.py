...
### QUI fai tutta una parte di pre-elaboraioen e trattamento delle serie
## usando delle funzioni che crei a parte 
...
# check
explore_obj(dataset_windows.trials[4])
