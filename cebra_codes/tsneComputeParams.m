...
params.early_exaggeration_iter  =    250;            
params.early_exaggeration       =    'auto';       
params.n_iter                   =    500;             
params.dof                      =    1;               
params.theta                    =    0.5;          
params.n_interpolation_points   =    3;             
params.min_num_intervals        =    50;             
params.ints_in_interval         =    1;             
params.initialization           =    'pca';            
params.metric                   =    'euclidean';     
params.initial_momentum         =    0.8;         
params.final_momentum           =    0.8;            
params.max_step_norm            =    5;            
params.n_jobs                   =    1;             
params.neighbors                =    'auto';               
params.negative_gradient_method =    'auto';      
params.callbacks_every_iters    =    50;                 
params.verbose                  =    'True';        
params.exec                     =    true;
