function [model_weghts, cebra_output] = func1(data,params,input_dir,output_dir)
...
script_path = fullfile(cebra_dir, script_name)
script_path
...
cebra_output=load(fullfile(output_dir, 'cebra_output.mat'));
end