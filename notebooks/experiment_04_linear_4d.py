# %% [markdown]
# # Linear track: enriched 4D latent space
#
# Adds velocity and trial context to position and direction. Localized place
# fields remain an explicit nonlinear contribution to neural drive.
