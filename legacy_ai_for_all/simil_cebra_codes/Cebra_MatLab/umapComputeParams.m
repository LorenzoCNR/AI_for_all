...
params.metric_kwds                  = 'None';
params.output_metric                = 'euclidean';
params.output_metric_kwds           = 'None' ;
params.n_epochs                     = 'None' ;
...
params.angular_rp_forest            = 'False' ;
params.target_n_neighbors           = -1 ;
params.target_metric                = 'categorical' ;
params.target_metric_kwds           = 'None' ;
params.target_weight                = 0.5 ;
params.transform_seed               = 42 ;
params.transform_mode               = 'embedding' ;
params.force_approximation_algorithm= 'False' ;
params.verbose                      = 'False' ;
params.tqdm_kwds                    = 'None' ;
params.unique                       = 'False' ;
params.densma                       = 'False' ;
params.dens_lambda                  = 2.0 ;
params. dens_frac                   = 0.3 ;
params.dens_var_shift               = 0.1 ;
params.  output_dens                = 'False' ;
params.disconnection_distance       = 'None' ;
params.precomputed_knn              = '(None= None= None)' ;
