...
'temperature', 1, 'max_iter', 1000, 'distance', 'cosine', 'conditional',...
    'time_delta','time_offsets',10,'hybrid', 'False');
...
%%% windows (cerca con where python...)

pyenv('Version', 'C:\Users\zlollo2\anaconda3\envs\cebra\python.exe', ...
    'ExecutionMode', 'InProcess');
...
%model_architecture='offset1-model', DA CAPIRE cfrguida in link sopra
...
%% settiamo i parametri (questi possono cambiare secondo indicazioni a seguire a piacimento)

general_params=struct{'main_fold', main_folder,'...',....}
save('general_params.mat', 'general_params')

model_params = struct('mod_arch', 'offset10-model', ...
    'distance', 'cosine', 'conditional', 'None', 'temperature', 1, 'time_offsets', 10, ...
    'max_iter', 1000, 'max_adapt_iter', 500, 'batch_size', 512, 'learning_rate', 3e-4, ...
...
%%% Una nota sui modelli che si fanno girare: cfr 
%%% https://cebra.ai/docs/api/sklearn/cebra.html#cebra.CEBRA.fit
